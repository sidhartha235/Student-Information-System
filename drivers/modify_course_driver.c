...
int main () {
    ...
    // modify
    modifyStudentCourse(1, 103, 10);
    modifyStudentCourse(5, 103, 10);
    modifyStudentCourse(3, 205, 30);
    modifyStudentCourse(3, 105, 69);
    modifyStudentCourse(1, 109, 98);
    modifyStudentCourse(2, 352, 33);
    modifyStudentCourse(1, 203, 38);
